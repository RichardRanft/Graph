...
namespace Graph
{
    ...
    [ToolboxData("<{0}:WebGraphControl runat=server></{0}:WebGraphControl>")]

    public class WebGraphControl : WebControl
    {
        [Bindable(true)]
        [Category("Appearance")]
        [DefaultValue("")]
        ...
        void UpdateMatrices()
        {
            ...
            var center = new PointF((float)this.Width.Value / 2.0f, (float)this.Height.Value / 2.0f);
        ...
        //        Pen temp = new Pen(SystemBrushes.ActiveCaption);
        //        e.Graphics.DrawRectangle(temp, marque_rectangle.X, marque_rectangle.Y, marque_rectangle.Width, marque_rectangle.Height);
        //    }
